...
3. The file "dsf.f90" contains the code for calculating the data for Fig.3. The corresponding data file is given by "dsf.dat".
4. The file "ssf.f90" contains the code for calculating the data for Fig.2(b). The corresponding data file is given by "ssf.dat".
...
4. Use the mathematica notebooks for plotting.
